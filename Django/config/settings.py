...
SECRET_KEY = 'd3&3)=qqe^g^(!t6t+g-@jw^$(0b523-dp5x$z6d9j3&vs#9_x'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = []
# ALLOWED_HOSTS = ['www.khrw.shirazipooya.ir', 'khrw.shirazipooya.ir']
...
INSTALLED_APPS = [
    ...
    'isotope_analysis.apps.IsotopeAnalysisConfig'
]
...
STATICFILES_DIRS = [
    ...
    BASE_DIR / "isotope_analysis/static"
]
