...
def read_spreadsheet(contents, filename):
    ...
    dateBank = pd.read_parquet(path="App/dashApp/isotope_analysis/assets/database/myDate.parquet.gzip")      
    ...
    if 'csv' in filename:        
        ...
        database.to_csv(
            path_or_buf='App/dashApp/isotope_analysis/assets/database/database.csv',
            encoding='utf-8', 
            index=False
        )
        return database
