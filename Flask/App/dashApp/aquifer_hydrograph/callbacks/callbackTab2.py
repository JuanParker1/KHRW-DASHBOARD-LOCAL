...
def callbackTab2(app):
    ...
    def update_content1Tab2(data, aquifer, wells, switch_disable, switch_on, start_year, end_date):
        ...
        df[['year_Date_Persian', 'month_Date_Persian', 'day_Date_Persian']
           ] = df.Date_Persian.str.split('-', expand=True)
        ...
        fig.update_yaxes(title_text="ارتفاع سطح آب ایستابی - متر",
                         secondary_y=False)
        ...
        if switch_disable is False and switch_on is True:
            ...
            fig.update_yaxes(
                title_text="عمق سطح ایستابی - متر", secondary_y=True)
