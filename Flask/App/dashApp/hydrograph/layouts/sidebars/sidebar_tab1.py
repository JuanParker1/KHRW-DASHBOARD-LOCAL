...
TAB1_SIDEBAR_LEFT_CARD_1_IMG = base64.b64encode(
    open('./App/static/hydrograph/images/database_logo.png', 'rb').read())  # EDITPATH
...
TAB1_SIDEBAR_LEFT_CARD_2_IMG = base64.b64encode(
    open('./App/static/hydrograph/images/excel_logo.png', 'rb').read())  # EDITPATH
...
TAB1_SIDEBAR_RIGHT_CARD_1_IMG_1 = base64.b64encode(
   open('./App/static/hydrograph/images/aquifer.jpg', 'rb').read()
)  # EDITPATH

TAB1_SIDEBAR_RIGHT_CARD_1_IMG_2 = base64.b64encode(
   open('./App/static/hydrograph/images/well.png', 'rb').read()
)  # EDITPATH
