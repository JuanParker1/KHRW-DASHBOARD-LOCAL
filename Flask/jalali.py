...
class Gregorian:
    ...
    def __init__(self, *date):
        ...
        if doy_j < 187:
            ...
            jd = doy_j - 186 - (jm * 30)
            jm += 7
        self.persian_year = str(jy).zfill(4)
        self.persian_month = str(jm).zfill(2)
        self.persian_day = str(jd).zfill(2)
...
class Persian:
    ...
    def __init__(self, *date):
        ...
        self.gregorian_year = gy.zfill(2)
        self.gregorian_month = gm.zfill(2)
        self.gregorian_day = gd.zfill(2)
